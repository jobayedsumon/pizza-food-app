...
class OrderRepo {
  ...
  Future<ApiResponse> placeOrderGuest(PlaceOrderGuestBody orderBody) async {
    try {
      final response = await dioClient.post(AppConstants.PLACE_ORDER_GUEST_URI, data: orderBody.toGuestJson());
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }

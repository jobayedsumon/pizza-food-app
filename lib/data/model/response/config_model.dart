class ConfigModel {
  ...
  ConfigModel(
    ...
    this._systemDeliveryCharge = systemDeliveryCharge;
  ...
  double get systemDeliveryCharge => _systemDeliveryCharge;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _systemDeliveryCharge = json['delivery_charge'].toDouble();

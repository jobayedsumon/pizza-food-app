...
class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    if (json['allergies'] != null) {
      ...
      json['allergies'].forEach((v) {
        _allergies.add(new Allergies.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._allergies != null) {
      data['allergies'] = this._allergies.map((v) => v.toJson()).toList();
    }
...
class Allergies {
  ...
  Allergies({int id, String name, double price, String createdAt, String updatedAt}) {
    this._id = id;
    this._name = name;
    this._createdAt = createdAt;
    this._updatedAt = updatedAt;

          ...
          children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(searchProvider.lowerValue !=null?PriceConverter.convertPrice(context, searchProvider.lowerValue):""),
                    Text(searchProvider.upperValue !=null?PriceConverter.convertPrice(context, searchProvider.upperValue):""),
                    Text(PriceConverter.convertPrice(context, maxValue)),
                  ],
                ),
              ),
              Container(height: 20,),

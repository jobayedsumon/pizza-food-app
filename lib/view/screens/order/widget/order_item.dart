              ...
              onTap: () async {
                if(isRunning) {
                  ...
                  orderDetails.forEach((orderDetail) {
                    ...
                    List<Allerg> _allergiesList = [];
                    for(int i = 0; i < orderDetail.allergIds.length; i++) {
                      _allergiesList.add(Allerg(id: orderDetail.allergIds[i], quantity: 0));
                    }
                    ...
                    _cartList.add(CartModel(
                        ...
                        orderDetail.taxAmount, _addOnList,_allergiesList, orderDetail.productDetails
                    )
                    );

...
class CartProductWidget extends StatelessWidget {
  ...
  CartProductWidget({@required this.cart, @required this.cartIndex, @required this.isAvailable, @required this.addOns, @required this.allergies});
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        cart.product.variations.length > 0 ? Padding(
                          padding: EdgeInsets.only(top: Dimensions.PADDING_SIZE_VERY_SMALL),
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: Row(children: [
                            InkWell(
                              onTap: () {
                                Provider.of<CartProvider>(context, listen: false).removeAllergies(cartIndex, index);
                              },
                              child: Padding(
                            ...
                            Text(allergies[index].name, style: rubikRegular),
                          ]),
                        );
                      },
                    ),
...
class CartProductMenuWidget extends StatelessWidget {
  final CartModel cart;
  final int cartIndex;
  final List<AddOns> addOns;
  final List<Allergies> allergies;
  final bool isAvailable;
  CartProductMenuWidget({@required this.cart, @required this.cartIndex, @required this.isAvailable, @required this.addOns, @required this.allergies});
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Stack(children: [
          Positioned(
            top: 0, bottom: 0, right: 0, left: 0,
            child: Icon(Icons.delete, color: ColorResources.COLOR_WHITE, size: 40),
          ),
          Dismissible(
            key: UniqueKey(),
            onDismissed: (DismissDirection direction) {
                    ...
                    Stack(
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: FadeInImage.assetNetwork(
                            placeholder: Images.placeholder_image, height: 60, width: 70, fit: BoxFit.cover,
                            image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${cart.product.image}',
                            imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder_image,  height: 60, width: 70, fit: BoxFit.cover),
                          ),
                        ),
                        isAvailable ? SizedBox() : Positioned(
                          top: 0, left: 0, bottom: 0, right: 0,
...
class CartProductWithoutActionWidget extends StatelessWidget {
  final CartModel cart;
  final int cartIndex;
  final List<AddOns> addOns;
  final bool isAvailable;
  CartProductWithoutActionWidget({@required this.cart, @required this.cartIndex, @required this.isAvailable, @required this.addOns});

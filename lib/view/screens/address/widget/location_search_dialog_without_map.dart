...
class LocationSearchDialogWithoutMap extends StatelessWidget {
  final TextEditingController locationTextController;
  LocationSearchDialogWithoutMap({@required this.locationTextController});
        ...
        child: SizedBox(width: 1170, child: TypeAheadField(
          textFieldConfiguration: TextFieldConfiguration(
            ...
            decoration: InputDecoration(
              ...
              filled: false, fillColor: Theme.of(context).cardColor,
            ),

...
import 'package:flutter_restaurant/view/screens/address/widget/location_search_dialog_without_map.dart';
...
class AddNewAddressScreen extends StatefulWidget {
  ...
  AddNewAddressScreen({this.isEnableUpdate = false, this.address, this.fromCheckout = false,this.addressType});
          ...
          child: Container(
            ...
            child: !locationProvider.isLoading ? CustomButton(
              ...
              onTap: locationProvider.loading ? null : () {
                if(widget.addressType=='guest'){

                  if(_locationTextController.text.isEmpty){
                    showCustomSnackBar("Address is required", context);
                  }else if(_contactPersonNameController.text.isEmpty){
                    showCustomSnackBar("Contact Person Name is required", context);
                    ...
                    if(!_isAvailable) {
                      ...
                      if(widget.addressType=='guest'){
                        ...
                        setState(() {
                          DELIVERY_ADDRESS = _locationTextController.text ?? '';
                          GuestAddress = jsonEncode(addressModel.toJson()).toString();
                        });
                        Navigator.pushNamed(context, Routes.getCheckoutRoute(
                          TOTALDeliveryFee, 'cart', Provider.of<OrderProvider>(context, listen: false).orderType,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Center(
                  child: Text(
                    ...
                    style:
                    Theme.of(context).textTheme.headline3.copyWith(color: ColorResources.getGreyBunkerColor(context), fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE),
                  ),
                ),
              ),
              ...
              LocationSearchDialogWithoutMap(locationTextController: _locationTextController),

    ...
    return Scaffold(
      ...
      floatingActionButton: _isLoggedIn ? Padding(
        ...
        child: !ResponsiveHelper.isDesktop(context) ? FloatingActionButton(
          ...
          onPressed: () =>  Navigator.pushNamed(context, Routes.getAddAddressRoute('address', 'add', AddressModel(),'default')),
        ) : null,
      ) : null,
                      ...
                      child: ConstrainedBox(
                        ...
                        child: SizedBox(
                          ...
                          Column(
                            ...
                            children: [
                              AddButtonView(onTap: () =>  Navigator.pushNamed(context, Routes.getAddAddressRoute('address', 'add', AddressModel(),'default'),)),
                              GridView.builder(
                ...
                Center(
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        if(ResponsiveHelper.isDesktop(context)) AddButtonView(onTap: () =>  Navigator.pushNamed(context, Routes.getAddAddressRoute('address', 'add', AddressModel(),'default'))),

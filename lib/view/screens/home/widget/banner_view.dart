                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              placeholder: Images.placeholder_banner, width: MediaQuery.of(context).size.width*.85, height: 130, fit: BoxFit.cover,
                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.bannerImageUrl}/${banner.bannerList[index].image}',
                              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder_banner, width: MediaQuery.of(context).size.width*.85, height: 130, fit: BoxFit.cover),
                            ),
                          ),
                        )
                      );

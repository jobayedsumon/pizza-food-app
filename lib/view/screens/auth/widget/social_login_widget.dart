    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, _) {
        return Column(children: [
          ...
          Center(child: Text(widget.type != "checkout"?'${getTranslated('sign_in_with', context)}':"Login to receive EXCLUSIVE offers", style: poppinsRegular.copyWith(

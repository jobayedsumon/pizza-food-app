                ...
                child: Consumer<AuthProvider>(
                  builder: (context, authProvider, child) => Column(
                    ...
                    children: [
                      ...
                      Container(
                        width:  ResponsiveHelper.isDesktop(context)?MediaQuery.of(context).size.width*.4:(ResponsiveHelper.isTab(context)?MediaQuery.of(context).size.width*.6:MediaQuery.of(context).size.width*.8),

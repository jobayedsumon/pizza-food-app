                            ...
                            child: OnHover(
                                builder: (isHover) {
                                  return Row(children: [
                                    ...
                                    SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                                    Text("Sign Up", style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: ColorResources.COLOR_WHITE))
                                  ],
                                  );
                                }
                            ),
          ...
          child: Center(
            child: SizedBox(
                ...
                child: Row(
                        ...
                        child: OnHover(
                            builder: (isHover) {
                              return Text(getTranslated('category', context),
                                  ...
                                  style: rubikRegular.copyWith(color: isHover ? Theme.of(context).primaryColor : ColorResources.getWhiteAndBlack(context),
                                  fontSize: Dimensions.FONT_SIZE_LARGE));
                            }
                          ),
                        ),
                 ...
                 InkWell(
                     onTap: () => Navigator.pushNamed(context, Routes.getDashboardRoute('dashboard')),

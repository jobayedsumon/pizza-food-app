                ...
                children: [
                  ...
                  Expanded(flex: 2,child: Column(
                    ...
                    children: [
                      ...
                      _isLoggedIn? Container():SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      _isLoggedIn?Container():OnHover(
                          builder: (hovered) {
                            return InkWell(
                                onTap: (){
                                  Navigator.pushNamed(context, Routes.getLoginRoute());
                                },
                                child: Text("Login", style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
                      _isLoggedIn?Container(): SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                      _isLoggedIn?Container():OnHover(
                          builder: (hovered) {
                            return InkWell(
                                ...
                                child: Text("Sign Up", style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ),
                      _isLoggedIn?SizedBox(height: Dimensions.PADDING_SIZE_SMALL):Container(),
                      _isLoggedIn?OnHover(
                          builder: (hovered) {
                            return InkWell(
                                onTap: (){
                                ...
                                child: Text("Logout", style: hovered? rubikMedium.copyWith(color: Theme.of(context).primaryColor) : rubikRegular.copyWith(color: ColorResources.getGreyBunkerColor(context),fontSize: Dimensions.FONT_SIZE_DEFAULT)));
                          }
                      ):Container(),
...
class FooterViewForMenu extends StatelessWidget {
  const FooterViewForMenu({Key key}) : super(key: key);

...
class Routes {
  ...
  static const String DELIVERY_INFO_SCREEN = '/dashboard';
  ...
  static const String ORDER_SUCCESS_GUEST_SCREEN = '/order-successful-guest';
  ...
  static String getAddAddressRoute(String page, String action, AddressModel addressModel,String _type) {
    String _data = base64Url.encode(utf8.encode(jsonEncode(addressModel.toJson())));
    return '$ADD_ADDRESS_SCREEN?page=$page&action=$action&address=$_data&type=$_type';
  }
